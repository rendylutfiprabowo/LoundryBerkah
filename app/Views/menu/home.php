                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <h2>Loundry Berkah </h2>
                                </div>
                                <div class="col-lg-12">
                                    <div class="main-green-button scroll-to-section">
                                        <a href="/pesanlayanan">Pesan Layanan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                            <img src="/assets/seo/images/banner-right-image.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s">
                                ...
                                <p>Layanan self service, mencuci sendiri dengan mesin cuci lewat pembelian koin kasir tanpa setrika dan lipat. Sekali cuci bisa hingga 5 Kg. Lebih Hemat!</p>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="features-item second-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                ...
                                <h4>Cuci Kering</h4>
                                <div class="line-dec"></div>
                                <p>Layanan cuci bersih dan press kering oleh karyawan kami tanpa setrika dan lipat, harga Rp.4000/Kg. Bisa ditunggu!</p>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                ...
                                <h4>Cuci Setrika</h4>
                                <div class="line-dec"></div>
                                <p>Layanan tambahan cuci bersih setrika, tanpa lipat. Harga Rp.4500/Kg</p>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="features-item second-feature last-features-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                ...
                                <h4>Cuci Lipat</h4>
                                <div class="line-dec"></div>
                                <p>Paket lengkap++, layananan cuci hingga lipat rapi. Hanya Rp.5000/Kg saja, baju kamu sudah rapi kembali!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="skills-content">
                    <div class="col-lg-6 align-self-center wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-heading">
                            <h2 class="ml-5">Jaminan Mutu Kami...</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-3">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="left-image wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="/assets/seo/images/about-left-image.png" alt="">
                </div>
            </div>
            <div class="col-lg-6 align-self-center wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="section-heading">
            ...
            <div class="col-lg-4">
                <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="icon">
                                <img src="/assets/seo/images/service-icon-01.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="icon">
                                <img src="/assets/seo/images/service-icon-02.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="right-content">
            ...
            <div class="col-lg-4">
                <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="icon">
                                <img src="/assets/seo/images/service-icon-03.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="right-content">
                ...
                <div class="loop owl-carousel">
                    <div class="item">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <img src="/assets/seo/images/portfolio-01.jpg" alt="">
                        ...
                        <div class="portfolio-item">
                            <div class="thumb">
                                <img src="/assets/seo/images/portfolio-04.jpg" alt="">
                                <div class="hover-content">
                                    <div class="inner-content">
                                        <a href="#">
                    ...
                    <div class="item">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <img src="/assets/seo/images/portfolio-02.jpg" alt="">
                                <div class="hover-content">
                                    <div class="inner-content">
                                        <a href="#">
                        ...
                        <div class="portfolio-item">
                            <div class="thumb">
                                <img src="/assets/seo/images/portfolio-05.jpg" alt="">
                                <div class="hover-content">
                                    <div class="inner-content">
                                        <a href="#">
                    ...
                    <div class="item">
                        <div class="portfolio-item">
                            <div class="thumb">
                                <img src="/assets/seo/images/portfolio-03.jpg" alt="">
                                <div class="hover-content">
                                    <div class="inner-content">
                                        <a href="#">
                        ...
                        <div class="portfolio-item">
                            <div class="thumb">
                                <img src="/assets/seo/images/portfolio-06.jpg" alt="">
                                <div class="hover-content">
                                    <div class="inner-content">
                                        <a href="#">
